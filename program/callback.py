...
💡 **Bu bot hakkında takip eden bir sorunuz varsa, bunu buradaki destek sohbetimde iletebilirsiniz. @TgHizmetlerin**
...
» /asistan - gruba katılır
» /asistangit - gruptan çıkar
...
async def cbsudo(_, query: CallbackQuery):
    await query.edit_message_text(
        f"""🏮
Üzgünüm bu komutları sadece bot sahibi kullanabilir sen de kendine ait bir bot istiyorsan @TgHizmetlerin 'e yazabilirsin...
