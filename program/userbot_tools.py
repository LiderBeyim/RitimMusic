...
@Client.on_message(
    command(["asistan", f"asistan@{BOT_USERNAME}"]) & ~filters.private & ~filters.bot
)
...
@Client.on_message(command(["asistangit",
                            f"asistangit@{BOT_USERNAME}"]) & filters.group & ~filters.edited
)
@authorized_users_only
...
@Client.on_message(command(["asistangitall", f"leaveall@{BOT_USERNAME}"]))
@sudo_users_only
